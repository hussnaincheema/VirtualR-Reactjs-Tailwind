...
const Workflow = () => {
  return (
    <div id="workflow" className="mt-20 p-7">
      <h2 className="text-3xl capitalize sm:text-5xl lg:text-6xl text-center mt-6 tracking-wide">
        Accelerate your{" "}
        ...
        <div className="flex flex-wrap justify-center w-full lg:w-3/4">
          <div className="p-2 w-full lg:w-1/2 flex justify-center">
            <img
              src={codeImg}
              alt="Coding"
              className="max-w-full h-auto mt-7"
            />
          </div>
